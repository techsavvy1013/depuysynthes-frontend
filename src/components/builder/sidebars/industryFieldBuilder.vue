<template>
  <div class="">
      ...
      >
        ...
        >
          <div class="flex items-center">
            <p class="text-gray-650 font-bold text-base tracking-wide">{{ address[i].type }}</p>
          </div>
          <SvgIcon
    ...
    <div>
      ...
      <div 
        v-for="(consultant, j) in sultants" 
        :key="j"
        class="flex px-5"
      >
...
export default {
  data() {
    return {
      address: industryFieldDefault.address,
      experience: industryFieldDefault.experience,
      sultants: industryFieldDefault.consultants,
    };
  },
  watch: {
    address: {
  ...
  methods: {
    ...mapMutations({
      setAddress: "industryField/setAddress",
      setExperience: "industryField/setExperience",
      setConsultants: "industryField/setConsultants",
    }),
    addRow() {
      this.sultants.push({ name: "", contact: "" });
    },
